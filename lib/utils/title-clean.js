...
removeCountryNamesFromTitle = function (movieTitle) {
    return movieTitle.replace(
        /\b(VFQ|VF2|FRENCH|TRUEFRENCH|MULTI|MULTi|VFF|NL|SWE|SWESUB|ENG|JAP|BRAZIL|TURKIC|slavic|SLK|ITA|HEBREW|HEB|ESP|RUS|DE|german|french|FR|ESPA|dansk|HUN|iTALiAN|JPN|[Ii]ta|[Ee]ng)\b/g,
        "");
};
